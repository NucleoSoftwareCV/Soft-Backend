...
public class DataSeederOrchestrator {
    ...
    CommandLineRunner seedBaseData(
        ...
        return args -> {
            ...
            // Admin1@ -> $2a$12$WlwgtLQPCA//IGVmzkC9k.KNPklIc5T6Wo3u1liZF/yuajWexUfcW
            // Admin2# -> $2a$12$dLiLeyi2f51pBxHHEc1A5.q51Fe9aI/LFKABnZK1wrfS0EQU7cJBO
            userSeeder.seedUser("user1", "user1@oona.es",
                    "$2a$12$Lg.NO/N371FWxM4Q8zLMD.ZRtyKFhZx0DdkF.pYhP5lEo8ui0T9VG", Set.of(roleUser));
            userSeeder.seedUser("user2", "user2@oona.es",
                    "$2a$12$zfWqThYYydUBgUQ2/FGa4Oi3YMweIzonj5IMfGGskAX9igSxWDgIC", Set.of(roleUser));
            userSeeder.seedUser("admin_main1", "admin1@oona.es",
                    "$2a$12$WlwgtLQPCA//IGVmzkC9k.KNPklIc5T6Wo3u1liZF/yuajWexUfcW", Set.of(roleAdmin));
            userSeeder.seedUser("admin_main2", "admin2@oona.es",
                    "$2a$12$dLiLeyi2f51pBxHHEc1A5.q51Fe9aI/LFKABnZK1wrfS0EQU7cJBO", Set.of(roleAdmin));
            ...
            SpecialistProfile profileAna = specialistProfileSeeder.seedSpecialist(specUser1, "ana-psicologa",
                    ...
                    "https://anagomez.es");
            SpecialistProfile profileCarlos = specialistProfileSeeder.seedSpecialist(specUser2, "carlos-yoga",
